...
import com.bakigoal.soccerstats.databinding.FragmentSoccerBinding
...
class SoccerStatsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, s: Bundle?): View {
        val binding: FragmentSoccerBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_soccer, container, false
        )
